...
|---------|------|--------|---------------|--------------|
| A | Scaffold & Deploy | Not started | `docs/superpowers/plans/2026-05-17-feature-a-scaffold-deploy.md` | `docs/features/A-scaffold-deploy.md` |
| B | Import & Score Model | Not started | _(write before build)_ | `docs/features/B-import-score-model.md` |
