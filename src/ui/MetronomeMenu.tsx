...
/**
 * The metronome settings dropdown: time signature, downbeat accent, and beat
 * subdivision. Rendered only while the dropdown is open, so its inputs
 * initialise from the live renderer / audio-engine state each time it opens.
 */
